...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-highlight text-white rounded-md";
  ...
  return (
    ...
    <aside
      className={
        ...
        " top-0 text-gray-300  font-semibold  p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all "
      }
    >
